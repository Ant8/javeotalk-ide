...
/*  Todo 2: navigate around panels using alt+digit
pressing it again hides it if active
pressing shift+esc hides last active panel

if a panel has tabs, you can switch between them with alt+left/right
 */

/* todo 2a: navigate to todos panel and find todo 2b
 */

/*  todo 3: navigate to folder level up than one containing this class; you can do this
 by going to navigation bar (alt + home) and then moving to desired folder by cursor
  and finally by using F4. Go back by pressing esc
  */

/* todo 4: look around: ctrl + up/d, alt + u/d
...
class WarmUpDrillImpl : WarmUpDrill {
    ...
    //    todo 2d: go up and down through the methods using alt + up/down
